...
<body>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_lengkap" class="form-control"
                                        id="exampleInputPassword1" value="<?= $profil["nama_lengkap"]; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
                                    <select class="form-control" id="jenis_kelamin" name="jenis_kelamin" required>
                                        <option value="Laki-laki"
                                            <?php if ($profil['jenis_kelamin'] == 'Laki-laki') echo 'selected'; ?>>
                                            Laki-laki</option>
                                        <option value="Perempuan"
                                            <?php if ($profil['jenis_kelamin'] == 'Perempuan') echo 'selected'; ?>>
                                            Perempuan</option>
                                    </select>
                                </div>
                            </div>
    ...
    <section class="jumbotron" id="home">
        <main class="contain" data-aos="fade-right" data-aos-duration="1000">
            <h1 class="text-light">Sehatkan Dirimu Dengan Berolahraga di <span>Sport</span> Makassar </h1>
            <p>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="contain" data-aos="fade-left" data-aos-duration="1000">
                ...
                <p>Sport Center adalah pusat olahraga yang menyediakan berbagai fasilitas dan layanan penyewaan lapangan
                    untuk berbagai jenis olahraga. Tempat ini dirancang untuk memfasilitasi kegiatan olahraga dan
                    rekreasi bagi individu, kelompok, dan komunitas yang memiliki minat dalam berpartisipasi dalam
                    aktivitas fisik. Sport Center menawarkan beragam jenis lapangan yang dapat disewa untuk berbagai
                    jenis olahraga, seperti sepak bola, futsal, tenis, basket, voli, dan masih banyak lagi. Setiap
                    lapangan dilengkapi dengan fasilitas yang sesuai, termasuk garis-garis permainan, jaring, dan
    ...
    <section class="pembayaran" id="bayar">
        ...
        <ul class="border list-group list-group-flush mt-5">
            <li class="list-group-item">1. Pengguna harus membuat akun atau mendaftar sebagai anggota pada website Sport
                Center.</li>
            <li class="list-group-item">2. Pengguna dapat memilih jenis lapangan yang ingin dipesan, memilih tanggal dan
                waktu tertentu.</li>
            <li class="list-group-item">3. Pengguna harus memilih tanggal dan waktu, melihat harga sewa lapangan,
                mengisi jumlah jam atau durasi, melengkapi formulir pemesanan.</li>
            ...
            <li class="list-group-item">5. Lakukan pembayaran ke rekening yang sudah tertera dan upload bukti pembayaran
            </li>
            <li class="list-group-item">5. Setelah upload, tunggu admin menyetujui pembayaran anda</li>
            <li class="list-group-item">5. Setelah status sudah di setujui, silahkan datang ke Sport Center sesuai
                jadwal yang di pesan</li>
        </ul>
    </section>
    <!-- End Pembayaran -->
    ...
    <section id="contact" class="contact" data-aos="fade-down" data-aos-duration="1000">
        ...
        <div class="row">
            <div class="col">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3973.773347008107!2d119.4806869732937!3d-5.140155051979347!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dbee36496088e9b%3A0x49abe2ce1f41fe79!2sDIPANEGARA%20UNIVERSITY!5e0!3m2!1sid!2sid!4v1695646058056!5m2!1sid!2sid"
